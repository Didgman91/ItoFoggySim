...
module lib_scene_object_generator
    use libmath
    ...
    ! public functions
    public :: lib_scene_object_gerator_hcp_lattice
    public :: lib_scene_object_generator_hcp_lattice_fill_cuboid
    public :: lib_scene_object_generator_hcp_lattice_fill_sphere

    public :: lib_scene_object_generator_test_functions
    ...
    contains
        ...
        !
        function lib_scene_object_gerator_hcp_lattice(i, j, k, sphere_radius) result(rv)
            implicit none
            ! dummy
            integer, intent(in) :: i
            integer, intent(in) :: j
        ...
        end function lib_scene_object_gerator_hcp_lattice
        ...
        !
        function lib_scene_object_generator_hcp_lattice_fill_cuboid(d_o_j, size_x, size_y, size_z, sphere_radius) result(rv)
            implicit none
            ! dummy
            ...
            offset = offset - lib_scene_object_gerator_hcp_lattice(max_i, max_j, max_k, sphere_radius) / 2d0
            ...
            do i = 0, max_i
                do j = 0, max_j
                    do k = 0, max_k
                        x = x + 1
                        rv%hcp_lattice_coordiantes(x) = lib_scene_object_gerator_hcp_lattice(i, j, k, sphere_radius) &
                                                        + offset
                    end do
                end do
            end do

        end function lib_scene_object_generator_hcp_lattice_fill_cuboid
        ...
        !
        !
        function lib_scene_object_generator_hcp_lattice_fill_sphere(d_o_j, sphere_radius, lattice_sphere_radius, &
            ...
            rv%hcp_cuboid = lib_scene_object_generator_hcp_lattice_fill_cuboid(d_o_j, &
                                                                        2d0 * sphere_radius, &
                                                                        2d0 * sphere_radius, &
                                                                        2d0 * sphere_radius, &
        ...
        end function lib_scene_object_generator_hcp_lattice_fill_sphere

        function lib_scene_object_generator_test_functions() result(rv)
            implicit none
            ! dummy
            integer :: rv
            ...
            if (.not. test_lib_scene_object_generator_hcp_lattice_fill_cuboid()) rv = rv + 1
            if (.not. test_lib_scene_object_generator_hcp_lattice_fill_sphere()) rv = rv + 1

            print *, "-------------test_lib_scene_object_generator----------------"
            if (rv == 0) then
                print *, "test_lib_scene_object_generator tests: OK"
            else
                print *, rv,"test_lib_scene_object_generator test(s) FAILED"
            end if
            print *, "------------------------------------------------------"

            contains

                function test_lib_scene_object_generator_hcp_lattice_fill_cuboid() result(rv)
                    use file_io
                    implicit none
                    ! dummy
                    logical :: rv
                    ...
                    hcp_cuboid = lib_scene_object_generator_hcp_lattice_fill_cuboid(d_o_j, size_x, size_y, size_z, sphere_radius)
                ...
                end function test_lib_scene_object_generator_hcp_lattice_fill_cuboid

                function test_lib_scene_object_generator_hcp_lattice_fill_sphere() result(rv)
                    use file_io
                    implicit none
                    ! dummy
                    logical :: rv
                    ...
                    hcp_sphere = lib_scene_object_generator_hcp_lattice_fill_sphere(d_o_j, sphere_radius, lattice_sphere_radius, &
                ...
                end function test_lib_scene_object_generator_hcp_lattice_fill_sphere

        end function lib_scene_object_generator_test_functions
end module lib_scene_object_generator
